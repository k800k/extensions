...
const expectedCatalogEntries = [
  { id: "AllPornComic", version: "1.0.0-alpha.17", kind: "content", contentRating: "ADULT", compatibilityStatus: "supported", apiVersion: "1.0", icon: "icons/AllPornComic.png", license: "GPL-3.0-or-later" },
  ...
  { id: "MangaDex", version: "1.0.0-alpha.30", kind: "content", contentRating: "SAFE", compatibilityStatus: "supported", apiVersion: "1.0", icon: "icons/MangaDex.png", license: "GPL-3.0-or-later" },
  { id: "MangaDot", version: "1.0.0-alpha.7", kind: "content", contentRating: "SAFE", compatibilityStatus: "supported", apiVersion: "1.0", icon: "icons/MangaDot.png", license: "GPL-3.0-or-later" },
  { id: "MangaFox", version: "1.0.0-alpha.15", kind: "content", contentRating: "MATURE", compatibilityStatus: "supported", apiVersion: "1.0", icon: "icons/MangaFox.png", license: "GPL-3.0-or-later" },
