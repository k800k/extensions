...
const expectedCatalogEntries = [
  ...
  { id: "MangaBat", version: "1.0.0-alpha.15", kind: "content", contentRating: "SAFE", compatibilityStatus: "supported", apiVersion: "1.0", icon: "icons/MangaBat.png", license: "Apache-2.0" },
