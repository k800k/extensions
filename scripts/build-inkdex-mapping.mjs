...
const auxiliaryHosts = {
  ...
  MangaDex: ["api.mangadex.org", "uploads.mangadex.org", "auth.mangadex.org", "status.mangadex.org"],
...
const dynamicHostEvidence = {
  ...
  MangaDex: ["at-home/image base URLs can be supplied by MangaDex responses"],
