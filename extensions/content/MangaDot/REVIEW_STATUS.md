...
- Live smoke (2026-07-17): Anonymous HTTPS landing page rendered HTML on `mangadot.net`. The probe discarded response bodies beyond browser rendering and used no account, cookies, or activation approval.
