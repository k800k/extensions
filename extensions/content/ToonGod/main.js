...
const unavailable = () => { const error = new Error("ToonGod is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "ToonGod",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "ToonGod", fields: [] }),
