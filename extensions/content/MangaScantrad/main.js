...
const unavailable = () => { const error = new Error("MangaScantrad is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "MangaScantrad",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "MangaScantrad", fields: [] }),
