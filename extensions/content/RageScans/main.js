...
const unavailable = () => { const error = new Error("RageScans is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "RageScans",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "RageScans", fields: [] }),
