...
const unavailable = () => { const error = new Error("SushiScans is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "SushiScans",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "SushiScans", fields: [] }),
