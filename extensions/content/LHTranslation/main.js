...
const unavailable = () => { const error = new Error("LHTranslation is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "LHTranslation",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "LHTranslation", fields: [] }),
