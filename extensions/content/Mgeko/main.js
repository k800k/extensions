...
const unavailable = () => { const error = new Error("Mgeko is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "Mgeko",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "Mgeko", fields: [] }),
