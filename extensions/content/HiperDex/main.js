...
const unavailable = () => { const error = new Error("HiperDex is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "HiperDex",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "HiperDex", fields: [] }),
