...
const unavailable = () => { const error = new Error("PunkRecords is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "PunkRecords",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "PunkRecords", fields: [] }),
