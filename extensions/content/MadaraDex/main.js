...
const unavailable = () => { const error = new Error("MadaraDex is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "MadaraDex",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "MadaraDex", fields: [] }),
