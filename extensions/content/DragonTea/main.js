...
const unavailable = () => { const error = new Error("DragonTea is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "DragonTea",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "DragonTea", fields: [] }),
