...
const unavailable = () => { const error = new Error("SetsuScans is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "SetsuScans",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "SetsuScans", fields: [] }),
