...
const unavailable = () => { const error = new Error("AllManga is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "AllManga",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "AllManga", fields: [] }),
