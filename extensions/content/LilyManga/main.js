...
const unavailable = () => { const error = new Error("LilyManga is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "LilyManga",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "LilyManga", fields: [] }),
