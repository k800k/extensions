...
const unavailable = () => { const error = new Error("Thunderscans is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "Thunderscans",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "Thunderscans", fields: [] }),
