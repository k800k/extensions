...
const unavailable = () => { const error = new Error("AllPornComic is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "AllPornComic",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "AllPornComic", fields: [] }),
