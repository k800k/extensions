...
const unavailable = () => { const error = new Error("DrakeScans is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "DrakeScans",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "DrakeScans", fields: [] }),
