...
const unavailable = () => { const error = new Error("Webtoon is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "Webtoon",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "Webtoon", fields: [] }),
