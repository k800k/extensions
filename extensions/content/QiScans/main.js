...
const unavailable = () => { const error = new Error("QiScans is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "QiScans",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "QiScans", fields: [] }),
