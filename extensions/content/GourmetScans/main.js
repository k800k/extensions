...
const unavailable = () => { const error = new Error("GourmetScans is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "GourmetScans",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "GourmetScans", fields: [] }),
