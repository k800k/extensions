...
const unavailable = () => { const error = new Error("YaoiScan is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "YaoiScan",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "YaoiScan", fields: [] }),
