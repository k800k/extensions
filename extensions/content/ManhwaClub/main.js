...
const unavailable = () => { const error = new Error("ManhwaClub is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "ManhwaClub",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "ManhwaClub", fields: [] }),
