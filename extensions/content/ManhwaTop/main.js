...
const unavailable = () => { const error = new Error("ManhwaTop is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "ManhwaTop",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "ManhwaTop", fields: [] }),
