...
const unavailable = () => { const error = new Error("UToon is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "UToon",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "UToon", fields: [] }),
