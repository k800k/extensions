...
const unavailable = () => { const error = new Error("MangaKakalot is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "MangaKakalot",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "MangaKakalot", fields: [] }),
