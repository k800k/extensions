...
The extension sends user-initiated browse, search, details, chapter, or image requests only through MangaReader's brokered HTTPS client. Declared hosts: `img-r1.2xstorage.com`, `img-r2.2xstorage.com`, `imgs-2.2xstorage.com`, `www.mangakakalot.gg`.
