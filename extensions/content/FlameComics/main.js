...
const unavailable = () => { const error = new Error("FlameComics is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "FlameComics",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "FlameComics", fields: [] }),
