...
const unavailable = () => { const error = new Error("MangaKatana is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "MangaKatana",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "MangaKatana", fields: [] }),
