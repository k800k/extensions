...
const unavailable = () => { const error = new Error("Mangapill is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "Mangapill",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "Mangapill", fields: [] }),
