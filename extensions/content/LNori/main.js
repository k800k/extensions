...
const unavailable = () => { const error = new Error("LNori is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "LNori",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "LNori", fields: [] }),
