...
const unavailable = () => { const error = new Error("WebtoonXYZ is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "WebtoonXYZ",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "WebtoonXYZ", fields: [] }),
