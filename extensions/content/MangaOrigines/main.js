...
const unavailable = () => { const error = new Error("MangaOrigines is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "MangaOrigines",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "MangaOrigines", fields: [] }),
