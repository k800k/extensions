...
const unavailable = () => { const error = new Error("Raw1001 is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "Raw1001",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "Raw1001", fields: [] }),
