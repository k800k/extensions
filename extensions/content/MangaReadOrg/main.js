...
const unavailable = () => { const error = new Error("MangaReadOrg is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "MangaReadOrg",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "MangaReadOrg", fields: [] }),
