...
const unavailable = () => { const error = new Error("ArthurScan is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "ArthurScan",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "ArthurScan", fields: [] }),
