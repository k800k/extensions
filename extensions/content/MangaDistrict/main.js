...
const unavailable = () => { const error = new Error("MangaDistrict is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "MangaDistrict",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "MangaDistrict", fields: [] }),
