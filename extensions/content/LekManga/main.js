...
const unavailable = () => { const error = new Error("LekManga is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "LekManga",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "LekManga", fields: [] }),
