...
const unavailable = () => { const error = new Error("MangaWorldAdult is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "MangaWorldAdult",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "MangaWorldAdult", fields: [] }),
