...
const unavailable = () => { const error = new Error("ManhwaRaw is awaiting review"); error.name = "ExtensionUnavailableError"; throw error; };
defineContentExtension({
  id: "ManhwaRaw",
  apiVersion: "1.0",
  initialize: unavailable,
  settings: () => ({ id: "settings", title: "ManhwaRaw", fields: [] }),
